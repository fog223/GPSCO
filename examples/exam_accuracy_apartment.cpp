/**
 *  \file   exam_accuracy_apartment.cpp
 *  \brief  Evaluation of the accuracy of the algorithm GPSCO(ETH,ALS Datasets - Apartment)
 *  \author fog
...
//		}
//
//		if ((pair.first == 5 && pair.second == 6)
//			|| (pair.first == 9 && pair.second == 10)
//			|| (pair.first == 36 && pair.second == 37))
//		{ options.max_plane_num = 10; }
		...
		if ((pair.first == 6 && pair.second == 7)
			|| (pair.first == 12 && pair.second == 13)
			|| (pair.first == 29 && pair.second == 30)
			|| (pair.first == 40 && pair.second == 41)
			|| (pair.first == 41 && pair.second == 42)
			|| (pair.first == 42 && pair.second == 43))
		{ options.max_plane_num = 20; }
